...
describe("Config", () => {
  ...
  describe("contextMenuActionsVisibility", () => {
    ...
    it("Should map legacy createArchive overrides onto createLocalBranch", () => {
      // Setup
      vscode.mockExtensionSettingReturnValue("contextMenuActionsVisibility", {
        branch: {
          createArchive: false,
      ...
      // Assert
      expect(value.branch.createLocalBranch).toBe(false);
      expect(value.remoteBranch.createLocalBranch).toBe(false);
      expect(value.tag.createLocalBranch).toBe(false);
    });
  });
  ...
  describe("dialogDefaults", () => {
    ...
    it("Should return TRUE values for boolean-based configuration values when they are truthy", () => {
      ...
      [
        ...
        vscode.mockExtensionSettingReturnValue(section, 1),
      );
    ...
    it("Should return the default values for text-based configuration values when they are invalid", () => {
      ...
      [
        ...
        vscode.mockExtensionSettingReturnValue(section, "invalid"),
      );
  ...
  describe(
    "markdown",
    testBooleanExtensionSetting("markdown", "markdown", true),
  );
  ...
  describe(
    "signTags",
    testBooleanExtensionSetting("signTags", "repository.sign.tags", false),
  );
