...
export interface BufferedQueueDiagnostics {
...
export class BufferedQueue<T> extends Disposable {
  ...
  /**
   * Get lightweight diagnostics for the queue state.
   */
  public getDiagnostics(): BufferedQueueDiagnostics {
    return {
      size: this.queue.length,
      processing: this.processing,
      hasPendingTimer: this.timeout !== null,
    };
  }
